...
public class stock_panel : MonoBehaviour
{
    ...
    public TextMeshProUGUI price1og_text;
    public TextMeshProUGUI price2og_text;
    public TextMeshProUGUI price3og_text;
    ...
    void FixedUpdate()
    {
        ...
        price1og_text.SetText($"{player.stock1og}");
        price2og_text.SetText($"{player.stock2og}");
        price3og_text.SetText($"{player.stock3og}");

        own1_text.SetText($"{player.stock1.ToString("N0")}");
        own2_text.SetText($"{player.stock2.ToString("N0")}");
        own3_text.SetText($"{player.stock3.ToString("N0")}");
